...
{
	var college_reference_list = [ "Other",
...
"Wright State University"];
	...
	for (var i = 0; i < country_ref_list.length; i++) {
	...
	var dynamic_tags_college = ["app_school", "app_prevSchool"];
	
	for (var j = 0; j < dynamic_tags_college.length; j++) {
		var college_ddm = document.getElementById(dynamic_tags_college[j]);
		
		for (var i = 0; i < college_reference_list.length; i++) {
